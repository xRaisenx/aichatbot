...
export function ProductComparison({ products }) {
    ...
    return (<div className="product-comparison-container border-t border-border-light dark:border-border-dark pt-3 mt-3">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
        {products.map((product, index) => (<div key={index} className="border border-gray-300 dark:border-gray-600 p-3 rounded-md">
